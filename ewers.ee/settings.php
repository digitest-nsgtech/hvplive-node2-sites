...
$base_url = 'https://ewers.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/ewers.ee/files';
$settings['file_private_path'] = 'sites/ewers.ee/privatefiles';
$settings['file_temp_path'] = 'sites/ewers.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'ewers_ee_db',
  'username' => 'ewers_ee_user',
  'password' => 'DqF29/94YyWqIrj4NpIwzu9HPSNYUvSy',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
