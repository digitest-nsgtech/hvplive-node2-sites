...
$base_url = 'https://kpk.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/kpk.edu.ee/files';
$settings['file_private_path'] = 'sites/kpk.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/kpk.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'kpk_edu_ee_db',
  'username' => 'kpk_edu_ee_user',
  'password' => 'hBM6Xjj0JipIBJ6jhJtKWPZOXbQHfsEM',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
