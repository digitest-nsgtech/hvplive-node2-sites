...
$base_url = 'https://sjg.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/sjg.edu.ee/files';
$settings['file_private_path'] = 'sites/sjg.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/sjg.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'sjg_edu_ee_db',
  'username' => 'sjg_edu_ee_user',
  'password' => 'Iw/YlTdvX1665+oijE0VvhCa+2+BrZPM',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
