...
$base_url = 'https://hiig.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/hiig.edu.ee/files';
$settings['file_private_path'] = 'sites/hiig.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/hiig.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'hiig_edu_ee_db',
  'username' => 'hiig_edu_ee_user',
  'password' => 'Q6V8pIxjzMep10QqhksR5WRIyK5VMdIr',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
