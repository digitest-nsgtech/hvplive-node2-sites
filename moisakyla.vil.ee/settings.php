...
$settings['trusted_host_patterns'] = [
  ...
  '^www\.moisakyla\.vil\.ee$',
  '^moisakyla\.vil\.ee$',
];

$base_url = 'https://moisakyla.vil.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/moisakyla.vil.ee/files';
$settings['file_private_path'] = 'sites/moisakyla.vil.ee/privatefiles';
$settings['file_temp_path'] = 'sites/moisakyla.vil.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'moisakyla_vil_ee_db',
  'username' => 'moisakyla_vil_ee_user',
  'password' => 'XmM9i3xGx7hKOEXuQTggW0wFqn/sSoxs',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
