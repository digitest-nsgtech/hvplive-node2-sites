...
$settings['trusted_host_patterns'] = [
  ...
  '^www\.kevadekool\.edu\.ee$',
  '^kevadekool\.edu\.ee$',
];

$base_url = 'https://kevadekool.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/kevadekool.edu.ee/files';
$settings['file_private_path'] = 'sites/kevadekool.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/kevadekool.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'kevadekool_edu_ee_db',
  'username' => 'kevadekool_edu_ee_user',
  'password' => 'XM9AVRYK6JXTbnwxl1bOsfSGrL/fR3iV',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
