...
$base_url = 'https://laeva.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/laeva.edu.ee/files';
$settings['file_private_path'] = 'sites/laeva.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/laeva.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'laeva_edu_ee_db',
  'username' => 'laeva_edu_ee_user',
  'password' => 'HVxXGcvI2O5ptqHzp12Du7RPI4dJVt3b',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
