...
$base_url = 'https://ng.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/ng.edu.ee/files';
$settings['file_private_path'] = 'sites/ng.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/ng.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'ng_edu_ee_db',
  'username' => 'ng_edu_ee_user',
  'password' => 'ZPJGbZuIVbtrZ8YHtP5MsyHJN9xVFJ2r',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
