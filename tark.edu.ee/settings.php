...
$base_url = 'https://tark.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/tark.edu.ee/files';
$settings['file_private_path'] = 'sites/tark.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/tark.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'tark_edu_ee_db',
  'username' => 'tark_edu_ee_user',
  'password' => 'g3YQFuEL4lVewiVobQJB5xfFjvo7hnMs',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
