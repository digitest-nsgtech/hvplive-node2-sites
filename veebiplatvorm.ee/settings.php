...
$settings['trusted_host_patterns'] = [
  ...
  '^www\.veebiplatvorm\.ee$',
  '^veebiplatvorm\.ee$',
];

$base_url = 'https://veebiplatvorm.ee';
...
$settings['file_public_path'] = 'sites/veebiplatvorm.ee/files';
$settings['file_private_path'] = 'sites/veebiplatvorm.ee/privatefiles';
$settings['file_temp_path'] = 'sites/veebiplatvorm.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'veebiplatvorm_ee_db',
  'username' => 'veebiplatvorm_user',
  'password' => 'veebiplatvorm_pass',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
