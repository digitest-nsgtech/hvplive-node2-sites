...
$base_url = 'https://osula.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/osula.edu.ee/files';
$settings['file_private_path'] = 'sites/osula.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/osula.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'osula_edu_ee_db',
  'username' => 'osula_edu_ee_user',
  'password' => 'Mb4Hdvo0sftDV0kPj/Ck6r0jvMJbgtA3',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
