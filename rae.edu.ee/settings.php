...
$base_url = 'https://rae.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/rae.edu.ee/files';
$settings['file_private_path'] = 'sites/rae.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/rae.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'rae_edu_ee_db',
  'username' => 'rae_edu_ee_user',
  'password' => 'zED9DLw3rc60IemGA96mHu2ru8Fy3tSL',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
