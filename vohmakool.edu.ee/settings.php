...
$settings['trusted_host_patterns'] = [
  ...
  '^www\.vohmakool\.edu\.ee$',
  '^vohmakool\.edu\.ee$',
];

$base_url = 'https://vohmakool.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/vohmakool.edu.ee/files';
$settings['file_private_path'] = 'sites/vohmakool.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/vohmakool.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'vohmakool_edu_ee_db',
  'username' => 'vohmakool_edu_ee_user',
  'password' => 'e5FXbMGBDznOV14Mt/USNBG0mVrb6+X0',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
