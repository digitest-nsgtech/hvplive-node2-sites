...
$settings['trusted_host_patterns'] = [
  ...
  '^www\.tammsaarekool\.parnu\.ee$',
  '^tammsaarekool\.parnu\.ee$',
];

$base_url = 'https://tammsaarekool.parnu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/tammsaarekool.parnu.ee/files';
$settings['file_private_path'] = 'sites/tammsaarekool.parnu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/tammsaarekool.parnu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'tammsaarekool_parnu_ee_db',
  'username' => 'tammsaarekool_parnu_ee_user',
  'password' => '5hjuG5NnOeF2YeK5aTap6NYAzy7+ia7E',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
