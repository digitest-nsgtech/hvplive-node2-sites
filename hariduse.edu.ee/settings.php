...
$base_url = 'https://hariduse.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/hariduse.edu.ee/files';
$settings['file_private_path'] = 'sites/hariduse.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/hariduse.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'hariduse_edu_ee_db',
  'username' => 'hariduse_edu_ee_user',
  'password' => 'CpFFAdLgXs66omjHPyVYlh8Iapjmgin8',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
