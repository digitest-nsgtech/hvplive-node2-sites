...
$base_url = 'https://mustjala.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/mustjala.edu.ee/files';
$settings['file_private_path'] = 'sites/mustjala.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/mustjala.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'mustjala_edu_ee_db',
  'username' => 'mustjala_edu_ee_user',
  'password' => 'G5AqRaFhmxoucxTqcU9C7KwKEW94PTWS',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
