...
$settings['trusted_host_patterns'] = [
  ...
  '^www\.murastekool\.edu\.ee$',
  '^murastekool\.edu\.ee$',
];

$base_url = 'https://murastekool.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/murastekool.edu.ee/files';
$settings['file_private_path'] = 'sites/murastekool.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/murastekool.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'murastekool_edu_ee_db',
  'username' => 'murastekool_edu_ee_user',
  'password' => 'zZakZqjK4oemiT2RBF4SLpF0w/6XYAc9',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
