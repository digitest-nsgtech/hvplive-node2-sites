...
$base_url = 'https://jooprepk.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/jooprepk.ee/files';
$settings['file_private_path'] = 'sites/jooprepk.ee/privatefiles';
$settings['file_temp_path'] = 'sites/jooprepk.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'jooprepk_ee_db',
  'username' => 'jooprepk_ee_user',
  'password' => 'FVEm47eZvaWHL64cM/8R/HaL0XzDD7Dv',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
