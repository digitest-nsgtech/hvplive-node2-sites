...
$settings['trusted_host_patterns'] = [
  ...
  '^www\.sindilasteaed\.ee$',
  '^sindilasteaed\.ee$',
];

$base_url = 'https://sindilasteaed.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/sindilasteaed.ee/files';
$settings['file_private_path'] = 'sites/sindilasteaed.ee/privatefiles';
$settings['file_temp_path'] = 'sites/sindilasteaed.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'sindilasteaed_ee_db',
  'username' => 'sindilasteaed_ee_user',
  'password' => 'ShPqRrhdgOcURKfmQ6IK6kS5QZT7mAq3',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
