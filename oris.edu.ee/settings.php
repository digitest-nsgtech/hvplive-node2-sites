...
$base_url = 'https://oris.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/oris.edu.ee/files';
$settings['file_private_path'] = 'sites/oris.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/oris.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'oris_edu_ee_db',
  'username' => 'oris_edu_ee_user',
  'password' => 'k5ZMw+WHggoRQ4dwxD2rZqPFIKtKaUdi',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
