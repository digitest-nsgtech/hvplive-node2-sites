...
$base_url = 'https://vabakool.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/vabakool.edu.ee/files';
$settings['file_private_path'] = 'sites/vabakool.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/vabakool.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'vabakool_edu_ee_db',
  'username' => 'vabakool_edu_ee_user',
  'password' => '4G0l9zDa37AKWeOTXfojRz+AoRMmjj3p',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
