...
$base_url = 'https://jklk.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/jklk.edu.ee/files';
$settings['file_private_path'] = 'sites/jklk.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/jklk.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'jklk_edu_ee_db',
  'username' => 'jklk_edu_ee_user',
  'password' => 'b0XsjlJDppYEHVNi2mQ+LWfcQt4SlZHp',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
