...
$base_url = 'https://kaina.edu.ee';

$settings['hash_salt']  = file_get_contents(__DIR__ . '/salt.txt');

$settings['update_free_access'] = FALSE;
$settings['file_public_path'] = 'sites/kaina.edu.ee/files';
$settings['file_private_path'] = 'sites/kaina.edu.ee/privatefiles';
$settings['file_temp_path'] = 'sites/kaina.edu.ee/tmp';
...
$databases['default']['default'] = array (
  'database' => 'kaina_edu_ee_db',
  'username' => 'kaina_edu_ee_user',
  'password' => 'RiYIC9gNy6mog4LOpM4C9FHVs3oC+09Q',
  'prefix' => '',
  'host' => '10.0.4.5',
  'port' => '3306',
